...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        u'current-directory-for-customuser', u'current-drive',
        ...
        u'exn:fail:unsupported?', u'exn:fail:customuser', u'exn:fail:customuser?',
        ...
        u'expand-syntax-to-top-form', u'expand-to-top-form', u'expand-customuser-path',
        ...
        u'make-exn:fail:customuser', u'make-file-or-directory-link',
        ...
        u'raise-customuser-error', u'random', u'random-seed', u'range', u'rational?',
        ...
        u'struct:exn:fail:customuser', u'struct:srcloc',
        ...
        u'use-compiled-file-paths', u'use-customuser-specific-search-paths',
        u'customuser-execute-bit', u'customuser-read-bit', u'customuser-write-bit', u'value-blame',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'use-global-map', 'use-local-map', 'customuser-full-name',
        'customuser-login-name', 'customuser-real-login-name', 'customuser-real-uid',
        'customuser-uid', 'variable-binding-locus', 'vconcat', 'vector',
        ...
        'waiting-for-customuser-input-p', 'where-is-internal', 'widen',
