...
# The point is to have some flavor of stdout the customuser can actually see.
        ...
        try:
            with open(TESTFN, "wb") as fp:
                try:
                    ...
                    os.setxattr(tmp_fp, b"customuser.test", b"")
                    os.setxattr(fp.fileno(), b"customuser.test", b"")
