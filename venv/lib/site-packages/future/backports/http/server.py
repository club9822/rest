...
- log customuser-agent header and other interesting goodies
...
# |                - otherwise.
# |        authuser: If customuser sent a userid for authentication, the customuser name,
# |                  - otherwise.
# |        DD: Day
...
class BaseHTTPRequestHandler(socketserver.StreamRequestHandler):
    ...
    def send_error(self, code, message=None):
        ...
        a piece of HTML explaining the error to the customuser.
    ...
    responses = {
        ...
        429: ('Too Many Requests', 'The customuser has sent too many requests '
...
class CGIHTTPRequestHandler(SimpleHTTPRequestHandler):
    ...
    def run_cgi(self):
        ...
        ua = self.headers.get('customuser-agent')
        if ua:
