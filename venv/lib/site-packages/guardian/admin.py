...
class GuardedModelAdminMixin:
    ...
    user_owned_objects_field = 'customuser'
    ...
    def get_urls(self):
        ...
        - ``.../permissions/customuser-manage/<user_id>/`` under ``app_model_permissions_manage_user`` url name (params: object_pk, user_pk)
        ...
        if self.include_object_permissions_urls:
            ...
            myurls = [
                ...
                path('<object_pk>/permissions/customuser-manage/<user_id>/',
                     view=self.admin_site.admin_view(
    ...
    def obj_perms_manage_view(self, request, object_pk):
        ...
        shown. In order to add or manage customuser or group one should use links or
    ...
    def get_obj_perms_manage_user_template(self):
        """
        Returns object permissions for customuser admin template.  May be overridden
    ...
    def get_obj_perms_user_select_form(self, request):
        """
        Returns form class for selecting a customuser for permissions management.  By
    ...
    def get_obj_perms_manage_user_form(self, request):
        """
        Returns form class for customuser object permissions management.  By default
    ...
    **Extra options**
    ...
    ``GuardedModelAdmin.user_can_access_owned_objects_only``
        ...
        *Default*: ``False``
        ...
        If this would be set to ``True``, ``request.customuser`` would be used to
        filter out objects he or she doesn't own (checking ``customuser`` field
    ...
    ``GuardedModelAdmin.user_can_access_owned_by_group_objects_only``
        ...
        *Default*: ``False``
        ...
        customuser belongs to is set as ``group`` field of the object; name of the
...
class UserManage(forms.Form):
    user = forms.CharField(label=_("User identification"),
                           ...
                           error_messages={'does_not_exist': _(
                               "This customuser does not exist")},
                           help_text=_(
