...
class BaseObjectPermission(models.Model):
    ...
    a ``content_object`` field and either ``customuser`` or ``group`` field.
    """
    ...
    def __str__(self):
        return '{} | {} | {}'.format(
            ...
            str(getattr(self, 'customuser', False) or self.group),
...
class UserObjectPermission(UserObjectPermissionBase, BaseGenericObjectPermission):
    ...
    class Meta(UserObjectPermissionBase.Meta, BaseGenericObjectPermission.Meta):
        unique_together = ['customuser', 'permission', 'object_pk']
