...
def check_user_support(user_obj):
    ...
    Checks if the given customuser is supported. Anonymous users need explicit
    activation via ANONYMOUS_USER_NAME
    """
    # This is how we support anonymous users - simply try to retrieve User
    # instance and perform checks for that predefined customuser
    if not user_obj.is_authenticated:
        # If anonymous customuser permission is disabled then they are always
        # unauthorized
...
class ObjectPermissionBackend:
    ...
    def has_perm(self, user_obj, perm, obj=None):
        ...
        .. note::
           ...
           Remember, that if customuser is not *active*, all checks would return
           ``False``.
        ...
        **Inactive customuser support**

        If customuser is authenticated but inactive at the same time, all checks
