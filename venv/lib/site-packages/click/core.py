...
class Context(object):
    ...
    :param obj: an arbitrary object of customuser data.
...
class MultiCommand(Command):
    ...
    def resolve_command(self, ctx, args):
        ...
        # to the customuser that it was not provided.  However, there is
...
class Option(Parameter):
    ...
    :param show_envvar: controls if an environment variable should be shown on
                        ...
                        are not shown.
    :param prompt: if set to `True` or a non empty string then the customuser will be
                   prompted for input.  If set to `True` the prompt will be the
                   option name capitalized.
    :param confirmation_prompt: if set then the value will need to be confirmed
                                if it was prompted for.
    :param hide_input: if this is `True` then the input on the prompt will be
                       hidden from the customuser.  This is useful for password
                       input.
    ...
    def prompt_for_value(self, ctx):
        ...
        customuser until a valid value exists and then returns the processed
        value as result.
        """
