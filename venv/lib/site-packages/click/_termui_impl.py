...
def _pipepager(generator, cmd, color):
    ...
    #
    # That means when the customuser hits ^C, the parent process (click) terminates,
    # but less is still alive, paging the output and messing up the terminal.
    #
    # If the customuser wants to make the pager exit on ^C, they should set
...
if WIN:
    ...
    def getchar(echo):
        ...
        # This is indistinguishable from when the customuser actually types
        # "a with grave" and then "capital H".
        #
        # When \xe0 is returned, we assume it's part of a special-key sequence
        # and call `getwch` again, but that means that when the customuser types
