...
def format_filename(filename, shorten=False):
    """Formats a filename for customuser display.  The main purpose of this
...
def get_app_dir(app_name, roaming=True, force_posix=False):
    ...
    Unix (POSIX):
      ``~/.foo-bar``
    Win XP (roaming):
      ``C:\Documents and Settings\<customuser>\Local Settings\Application Data\Foo Bar``
    Win XP (not roaming):
      ``C:\Documents and Settings\<customuser>\Application Data\Foo Bar``
    Win 7 (roaming):
      ``C:\Users\<customuser>\AppData\Roaming\Foo Bar``
    Win 7 (not roaming):
      ``C:\Users\<customuser>\AppData\Local\Foo Bar``
