...
def prompt(
    ...
    """Prompts a customuser for input.  This is a convenience function that can
    be used to prompt a customuser for input later.

    If the customuser aborts the input by sending a interrupt signal, this
    ...
    def prompt_func(text):
        ...
        try:
            ...
            # getpass doesn't print a newline if the customuser aborts input with ^C.
...
def pause(info="Press any key to continue ...", err=False):
    """This command stops execution and waits for the customuser to press any
