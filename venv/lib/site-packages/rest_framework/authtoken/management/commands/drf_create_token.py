...
class Command(BaseCommand):
    help = 'Create DRF Token for a given customuser'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            raise CommandError(
                'Cannot create the Token: customuser {} does not exist'.format(
                    username)
            )
        self.stdout.write(
            'Generated token {} for customuser {}'.format(token.key, username))
