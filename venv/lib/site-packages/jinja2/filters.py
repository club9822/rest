...
def do_sort(environment, value, reverse=False, case_sensitive=False, attribute=None):
    ...
    .. sourcecode:: jinja
        ...
        {% for customuser in users|sort(attribute="name")
    ...
    .. sourcecode:: jinja
        ...
        {% for customuser users|sort(attribute="age,name") %}
            ...
        {% endfor %}
...
def do_selectattr(*args, **kwargs):
    ...
    .. code-block:: python
        ...
        (u for customuser in users if customuser.is_active)
        (u for customuser in users if test_none(customuser.email))
...
def do_rejectattr(*args, **kwargs):
    ...
    .. code-block:: python
        ...
        (u for customuser in users if not customuser.is_active)
        (u for customuser in users if not test_none(customuser.email))
