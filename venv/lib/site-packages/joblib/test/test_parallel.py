...
def test_nested_exception_dispatch(backend):
    ...
    report this kind of information to the customuser.
    """
    ...
    # in the final error message reported to the customuser
...
def test_backend_hinting_and_constraints():
    ...
    with parallel_backend('loky', n_jobs=2):
        # Explicit backend selection by the customuser with the context manager
...
def test_threadpool_limitation_in_child_override(n_jobs, var_name):
    # Check that environment variables set by the customuser on the main process
