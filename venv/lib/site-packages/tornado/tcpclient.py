...
class TCPClient(object):
    ...
    async def connect(
        ...
        In case the customuser needs to resolve and
        ...
        Similarly, when the customuser requires a certain source port, it can
    ...
    def _create_stream(
        ...
        if source_port_bind or source_ip_bind:
            # If the customuser requires binding also to a specific IP/port.
            try:
