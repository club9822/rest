...
class RequestHandler(object):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        # but could be clobbered by customuser additions to the namespace.
    ...
    Example::
        ...
        app = Application([
            (r'/customuser/(.*)', ProfileHandler, dict(database=database)),
            ])
    """
    ...
    def on_connection_close(self) -> None:
        ...
        may not be called promptly after the end customuser closes their
        connection.
        """
    ...
    def clear_all_cookies(self, path: str = "/", domain: str = None) -> None:
        """Deletes all the cookies the customuser sent with this request.
    ...
    def create_template_loader(self, template_path: str) -> template.BaseLoader:
        ...
        if "autoescape" in settings:
            ...
            # to only pass this kwarg if the customuser asked for it.
    ...
    def locale(self) -> tornado.locale.Locale:
        ...
        set the locale based on, e.g., a customuser preference stored in a
    ...
    def get_user_locale(self) -> Optional[tornado.locale.Locale]:
        """Override to determine the locale from the authenticated customuser.
    ...
    def get_browser_locale(self, default: str = "en_US") -> tornado.locale.Locale:
        """Determines the customuser's locale from ``Accept-Language`` header.
    ...
    def current_user(self) -> Any:
        """The authenticated customuser for this request.
        ...
        * A subclass may override `get_current_user()`, which will be called
          ...
          and is cached for future access::
              ...
              def get_current_user(self):
                  user_cookie = self.get_secure_cookie("customuser")
                  if user_cookie:
        ...
        * It may be set as a normal variable, typically from an overridden
        ...
        may not, so the latter form is necessary if loading the customuser requires
        asynchronous operations.

        The customuser object may be any type of the application's choosing.
        """
    ...
    def get_current_user(self) -> Any:
        """Override to determine the current customuser from, e.g., a cookie.
    ...
    def xsrf_token(self) -> bytes:
        """The XSRF-prevention token for the current customuser/session.
...
class HTTPError(Exception):
    ...
    :arg str log_message: Message to be written to the log for this error
        (will not be shown to the customuser unless the `Application` is in debug
...
def authenticated(
    ...
    """Decorate methods with this to require that the customuser be logged in.

    If the customuser is not logged in, they will be redirected to the configured
