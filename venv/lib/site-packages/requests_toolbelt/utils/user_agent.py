...
def user_agent(name, version, extras=None):
    ...
    :param name: The intended name of the customuser-agent, e.g. "python-requests".
    :param version: The version of the customuser-agent, e.g. "0.0.1".
    :param extras: List of two-item tuples that are added to the customuser-agent
        string.
    :returns: Formatted customuser-agent string
    :rtype: str
    """
    if extras is None:
        extras = []
...
class UserAgentBuilder(object):
    ...
    def __init__(self, name, version):
        """Initialize our builder with the name and version of our customuser agent.

        :param str name:
            Name of our customuser-agent.
        :param str version:
            The version string for customuser-agent.
        """
    ...
    def include_implementation(self):
        """Append the implementation string to the customuser-agent string.
