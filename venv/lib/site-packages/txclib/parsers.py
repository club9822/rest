...
def init_parser():
    ...
    parser.add_argument("--customuser", action="store", dest="customuser", default=None,
    ...
    parser.add_argument("--token", action="store", dest="token", default=None,
                        ...
                        " customuser's settings")
    parser.add_argument("--no-interactive", action="store_true",
                        dest="no_interactive", default=False,
                        help="Don't require customuser input.")
...
def pull_parser():
    ...
    description = \
        ...
        "folder and require the customuser to manually rename them and add then in "\
...
def push_parser():
    ...
    parser.add_argument("--no-interactive", action="store_true",
                        dest="no_interactive", default=False,
                        help="Don't require customuser input when forcing a push.")
    parser.add_argument("-x", "--xliff", action="store_true", dest="xliff",
