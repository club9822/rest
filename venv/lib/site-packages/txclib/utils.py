...
def confirm(prompt='Continue?', default=True):
    """
    Prompt the customuser for a Yes/No answer.
    Args:
        prompt: The text displayed to the customuser ([Y/n] will be appended)
...
def get_transifex_file(directory=None):
    ...
    It is in the home directory of the customuser by default.
    """
