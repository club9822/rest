...
class PyRunner(object):
    ...
    def run(self):
        ...
        try:
            ...
            # The customuser called sys.exit().  Just pass it along to the upper
            # layers, where it will be handled.
            raise
        except Exception:
            # Something went wrong while executing the customuser code.
            ...
            # and a nested exception is shown to the customuser.  This getattr fixes
