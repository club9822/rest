...
def django_user_model(db):
    """The class of Django's customuser model."""
...
def django_username_field(django_user_model):
    """The fieldname for the username used with Django's customuser model."""
    return django_user_model.USERNAME_FIELD


@pytest.fixture()
def admin_user(db, django_user_model, django_username_field):
    """A Django admin customuser.

    This uses an existing customuser with username "admin", or creates a new one with
    password "password".
    """
...
def admin_client(db, admin_user):
    """A Django test client logged in as an admin customuser."""
    from django.test.client import Client
