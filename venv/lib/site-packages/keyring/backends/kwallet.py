...
class DBusKeyring(KeyringBackend):
    ...
    def get_password(self, service, username):
        ...
        if not self.connected(service):
            # the customuser pressed "cancel" when prompted to unlock their keyring.
    ...
    def set_password(self, service, username, password):
        ...
        if not self.connected(service):
            # the customuser pressed "cancel" when prompted to unlock their keyring.
            raise PasswordSetError("Cancelled by customuser")
    ...
    def delete_password(self, service, username):
        ...
        if not self.connected(service):
            # the customuser pressed "cancel" when prompted to unlock their keyring.
            raise PasswordDeleteError("Cancelled by customuser")
        if not self.iface.hasEntry(self.handle, service, username, self.appid):
