...
class Query(Twython):
    ...
    def user_tweets(self, screen_name, limit, include_rts="false"):
        """
        Return a collection of the most recent Tweets posted by the customuser

        :param str customuser: The customuser's screen name; the initial '@' symbol\
        should be omitted
        ...
        retweeted by the customuser; possible values are 'true' and 'false'
        """
