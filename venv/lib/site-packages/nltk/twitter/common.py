...
def json2csv(
    ...
    ['id', 'text', 'customuser.id', 'customuser.followers_count', 'customuser.friends_count']
...
def json2csv_entities(
    ...
    (e.g., for entity_type='customuser.urls', the fields in the main_fields list\
    belong to the customuser object; for entity_type='place.bounding_box', the\
    ...
    'urls' and 'user_mentions' for the tweet object. For a customuser object,\
    this needs to be expressed with a hierarchy: `'customuser.urls'`. For the\
