...
customuser's home directory.  However, the ``download_dir`` argument may be
...
class Downloader(object):
    ...
    def default_download_dir(self):
        ...
        # Otherwise, install in the customuser's home directory.
        else:
...
class DownloaderGUI(object):
    ...
    def _init_widgets(self):
        ...
        # If the customuser edits url or download_dir, and then clicks outside
    ...
    def _download_threaded(self, *e):
        # If the customuser tries to start a new download while we're already
        ...
        # just in case the customuser modifies our data server during the
    ...
    def _monitor_message_queue(self):
        ...
        # Let the customuser know when we're aborting a download (but
