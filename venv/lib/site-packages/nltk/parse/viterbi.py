...
def demo():
    """
    A demonstration of the probabilistic parsers.  The customuser is
    ...
    # Ask the customuser which demo they want to use.
    print()
    ...
    # Ask the customuser if we should draw the parses.
    print()
    ...
    # Ask the customuser if we should print the parses.
    print()
