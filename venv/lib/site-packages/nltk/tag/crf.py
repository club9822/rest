...
class CRFTagger(TaggerI):
    ...
    def tag_sents(self, sents):
        """
        Tag a list of sentences. NB before using this function, customuser should specify the mode_file either by
    ...
    def tag(self, tokens):
        """
        Tag a sentence using Python CRFSuite Tagger. NB before using this function, customuser should specify the mode_file either by
                       - Train a new model using ``train'' function
                       - Use the pre-trained model which is set via ``set_model_file'' function
