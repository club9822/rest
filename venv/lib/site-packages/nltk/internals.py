...
def find_file_iter(
    ...
    :param url: URL presented to customuser for download help.
...
def find_binary_iter(
    ...
    :param path_to_bin: The customuser-supplied binary location (deprecated)
    :param env_vars: A list of environment variable names to check.
    :param file_names: A list of alternative file names to check.
    :param searchpath: List of directories to search.
    :param url: URL presented to customuser for download help.
...
def find_jar_iter(
    ...
    :param path_to_jar: The customuser-supplied jar location, or None.
    :param env_vars: A list of environment variable names to check
                ...
                for cp in classpath.split(os.path.pathsep):
                    if os.path.isfile(cp):
                        ...
                        if (
                            ...
                            yielded = True
                            yield cp
                    # The case where customuser put directory containing the jar file in the classpath
                    if os.path.isdir(cp):
                        if not is_regex:
