...
class RegexpChunkApp(object):
    ...
    _EVAL_DELAY = 1
    """If the customuser has not pressed any key for this amount of time (in
    ...
    def __init__(
        ...
        """A list of (grammar, precision, recall, fscore) tuples for
           grammars that the customuser has already tried."""

        self._history_index = 0
        """When the customuser is scrolling through previous grammars, this
