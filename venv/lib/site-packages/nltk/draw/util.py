...
class CanvasWidget(metaclass=ABCMeta):
    ...
    customuser can drag a canvas widget around the canvas.  By default,
    canvas widgets are not draggable.

    ``CanvasWidget`` provides callback support for two types of customuser
    ...
    the customuser clicks or drags a canvas widget with no registered
    ...
    def parent(self):
        ...
        :return: The hierarchical parent of this canvas widget.
            ...
            purposes of customuser interaction.
    ...
    def child_widgets(self):
        ...
        :return: A list of the hierarchical children of this canvas
            ...
            for purposes of customuser interaction.
    ...
    def bind_click(self, callback, button=1):
        ...
        :type button: int
        :param button: Which button the customuser should use to click on
    ...
    def _add_child_widget(self, child):
        ...
        considered part of this canvas widget for purposes of customuser
    ...
    def _remove_child_widget(self, child):
        ...
        be considered part of this canvas widget for purposes of customuser
        interaction.  ``_add_child_widget`` has two direct effects:
    ...
    def _manage(self):
        ...
        also called if the customuser calls the ``manage`` method on this
...
class TextWidget(CanvasWidget):
    ...
    Attributes:
      ...
      - ``draggable``: whether the text can be dragged by the customuser.
    """
...
class CanvasFrame(object):
    ...
    def print_to_file(self, filename=None):
        ...
        file.  If no filename is given, then prompt the customuser for one.
