...
#     - the customuser can drag the treelet onto one of those (or click on them?)
#     - the customuser can delete pieces of the tree from the working area
#       (right click?)
...
class CFGEditor(object):
    ...
    def _analyze_line(self, linenum):
        ...
        if CFGEditor._PRODUCTION_RE.match(line):
            ...
            # It's invalid; show the customuser where the error is.
