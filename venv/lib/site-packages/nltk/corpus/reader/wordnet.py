...
class WordNetCorpusReader(CorpusReader):
    ...
    def license(self, lang="eng"):
        ...
        if lang == "eng":
            ...
            raise WordNetError("Cannot determine license for customuser-provided tab file")
        else:
            raise WordNetError("Language is not supported.")
    ...
    def readme(self, lang="omw"):
        ...
        if lang == "eng":
            ...
            raise WordNetError("No README for customuser-provided tab file")
        else:
            raise WordNetError("Language is not supported.")
    ...
    def citation(self, lang="omw"):
        ...
        if lang == "eng":
            ...
            raise WordNetError("citation not known for customuser-provided tab file")
        else:
            raise WordNetError("Language is not supported.")
