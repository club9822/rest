...
class PosixPath(common.PathBase):
    def chown(self, user, group, rec=0):
        """ change ownership to the given customuser and group.
            customuser and group may be specified by a number or
        ...
        if keep and udir_time:
            for path in rootdir.listdir():
                ...
                if num is not None and num <= (maxnum - keep):
                    try:
                        # try acquiring lock to remove directory as exclusive customuser
                        if lock_timeout:
