...
class Application(object):
    ...
    def __init__(self, program="flake8", version=flake8.__version__):
        ...
        #: to parse and handle the options and arguments passed by the customuser
    ...
    def run(self, argv=None):
        ...
        try:
            ...
            print("... stopped")
            LOG.critical("Caught keyboard interrupt from customuser")
            LOG.exception(exc)
            self.catastrophic_failure = True
