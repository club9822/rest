...
class Manager(object):
    ...
    def _job_count(self):
        ...
        # - the customuser provided stdin and that's not something we can handle
        #   well
        ...
        # - the customuser provided some awful input
    ...
    def make_checkers(self, paths=None):
        ...
        def should_create_file_checker(filename, argument):
            ...
            is_stdin = filename == "-"
            # NOTE(sigmavirus24): If a customuser explicitly specifies something,
            ...
            # If it was specified explicitly, the customuser intended for it to be
            # checked.
            explicitly_provided = (
    ...
    def run(self):
        ...
        try:
            ...
            LOG.warning("Flake8 was interrupted by the customuser")
...
class FileChecker(object):
    ...
    def _make_processor(self):
        ...
        try:
            ...
            # then we need to format that exception for the customuser.
