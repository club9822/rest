...
class DecisionEngine(object):
    ...
    def was_selected(self, code):
        ...
        """Determine if the code has been selected by the customuser.
    ...
    def was_ignored(self, code):
        # type: (str) -> Union[Selected, Ignored]
        """Determine if the code has been ignored by the customuser.
    ...
    def more_specific_decision_for(self, code):
        ...
        if select and ignore:
            ...
            #   A customuser has a code that would generate an E126 violation which
            ...
            # If, however, the customuser hasn't specified a custom select, and
        ...
        if select or (extra_select and self.using_default_select):
            # Here, ignore was false-y and the customuser has either selected
    ...
    def make_decision(self, code):
        ...
        LOG.debug(
            'The customuser configured "%s" to be "%s", "%s"',
            code,
            selected,
            ignored,
        )
    ...
    def decision_for(self, code):
        ...
        rules as specified by the customuser in their configuration files and
        command-line flags.
...
class StyleGuide(object):
    """Manage a Flake8 customuser's style guide."""
    ...
    def should_report_error(self, code):
        ...
        by the customuser in their configuration files and command-line flags.
