...
class BaseFormatter(object):
    ...
    .. attribute:: filename
        ...
        If specified by the customuser, the path to store the results of the run.
    ...
    def show_source(self, error):  # type: (Violation) -> Optional[str]
        ...
        :type error:
            flake8.style_guide.Violation
        :returns:
            The formatted error string if the customuser wants to show the source.
            If the customuser does not want to show the source, this will return
            ``None``.
        :rtype:
            str
        """
